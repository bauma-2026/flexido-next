    ...
    <>
      ...
      <main className="bg-white text-neutral-950">
        ...
        <section className="relative overflow-hidden bg-neutral-950 text-white">
          ...
          >
            <source src="/video/flexido/hero-cnc.mp4" type="video/mp4" />
          </video>
          ...
          <Container className="relative z-10 py-20 sm:py-24 lg:py-28">
            <div className="max-w-[760px]">
              ...
              <p className="mt-5 max-w-[56ch] text-[16px] leading-7 text-white/75">
                Avtomatiziramo nalaganje, odvzem in tok kosov okoli CNC stroja
                — da proizvodnja teče stabilneje, z manj čakanja in manj ročnih
                prekinitev.
              </p>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
              <div className="max-w-[560px]">
                ...
                <p className="mt-5 text-[16px] leading-7 text-neutral-600">
                  Izgube nastajajo pred in po obdelavi — pri nalaganju,
                  odvzemu, čakanju na material, kontroli kosov ali prenosu v
                  naslednjo operacijo.
                </p>
          ...
          <Container>
            <div className="max-w-[720px]">
              ...
              <p className="mt-5 text-[16px] leading-7 text-neutral-600">
                ...
                predvidljivo, pozicija kosov pa je lahko kontrolirana pred
                naslednjim korakom.
              </p>

              <p className="mt-5 text-[15px] leading-7 text-neutral-500">
                Ne optimiziramo enega koraka. Uredimo proces, ki omogoča bolj
                stabilen cikel.
              </p>
            </div>
        ...
        >
          <Container>
            <div className="max-w-[720px]">
              ...
              <p className="mt-5 text-[16px] leading-7 text-neutral-600">
                Ko odstranimo ročne prekinitve in povežemo tok materiala, CNC
                proces začne delovati bolj predvidljivo in stabilno.
              </p>
            </div>
            ...
            <p className="mt-6 max-w-[600px] text-[14px] leading-6 text-neutral-500">
              Proces ne temelji več na improvizaciji, ampak na sistemu, ki
              deluje vsak dan enako.
            </p>
          </Container>
        </Section>
        ...
        {cncSystem ? (
          <section id="sistem" className="scroll-mt-24">
            <SystemBlock
              title={`${cncSystem.name} kot osnova avtomatizirane celice`}
              ...
              itemsAspect="square"
              items={cncSystem.gallery.slice(1, 5).map((item) => ({
                title: item.alt,
                desc:
                  item.alt === "Zalogovnik"
                    ? "Avtomatsko zlaganje ali priprava kosov v procesu."
                    : item.alt === "Čistilna postaja"
                      ? "Čiščenje kosov pred naslednjo operacijo."
                      : item.alt === "Graviranje"
                        ? "Označevanje kosov znotraj avtomatiziranega procesa."
                        : item.alt === "Vibro sortirna postaja"
                          ? "Organiziran dovod in orientacija kosov."
                          : "Dodatni modul za prilagoditev procesa.",
                image: item.src,
              }))}
            />
          </section>
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_420px] lg:items-center">
              <div className="max-w-[680px]">
                ...
                <h2 className="mt-3 max-w-[15ch] text-3xl font-semibold leading-[0.98] tracking-[-0.04em] text-neutral-950 sm:text-4xl lg:text-5xl">
                  Poglejmo vaš CNC proces.
                </h2>

                <p className="mt-5 max-w-[58ch] text-[15px] leading-7 text-neutral-600 sm:text-[16px]">
                  Skupaj pregledamo nalaganje, odvzem, tok kosov in mesta, kjer
                  CNC stroj izgublja čas — potem ocenimo, kje ima avtomatizacija
                  največji učinek.
                </p>
              ...
              <div className="overflow-hidden rounded-3xl border border-neutral-200 bg-neutral-100 shadow-[0_18px_60px_rgba(0,0,0,0.08)]">
                <div className="relative aspect-[4/3]">
                  <Image
                    ...
                    alt="CNC avtomatizacija proizvodnega procesa"
                    fill
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5">
                    ...
                    <p className="mt-2 max-w-[34ch] text-[15px] font-medium leading-6 text-white">
                      Kje CNC proces izgublja čas, stabilnost ali razpoložljivost stroja?
                    </p>
                  </div>
                </div>
              </div>
